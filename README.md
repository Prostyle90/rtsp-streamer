...
Download `DesktopStreamer-Windows.zip` from the [Releases](https://github.com/Prostyle90/rtsp-streamer/releases) page. Extract it and run `DesktopStreamer.exe`; no Python, FFmpeg or MediaMTX installation is required.
